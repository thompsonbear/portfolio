...
<div class="relative">
	<label
		class="relative flex flex-col opacity-80 focus-within:opacity-100 hover:opacity-100"
		for="email"
	>
		<textarea
			class="peer h-full resize-none rounded-lg border border-gray-300 bg-transparent p-4 text-start outline-none ring-gray-300 focus:ring-2"
			{name}
			{value}
			{required}
			placeholder=" "
